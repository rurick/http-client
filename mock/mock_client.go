...
func (mec *MockExtendedClient) GetJSON(ctx context.Context, url string, result any) error {
...
func (mec *MockExtendedClient) PostJSON(ctx context.Context, url string, body any, result any) error {
        return mec.GetJSON(ctx, url, result)
}

// PutJSON implements ExtendedHTTPClient interface
func (mec *MockExtendedClient) PutJSON(ctx context.Context, url string, body any, result any) error {
        return mec.GetJSON(ctx, url, result)
}

// PatchJSON implements ExtendedHTTPClient interface
func (mec *MockExtendedClient) PatchJSON(ctx context.Context, url string, body any, result any) error {
        return mec.GetJSON(ctx, url, result)
}
...
func (mec *MockExtendedClient) GetXML(ctx context.Context, url string, result any) error {
...
func (mec *MockExtendedClient) PostXML(ctx context.Context, url string, body any, result any) error {
        return mec.GetXML(ctx, url, result)
}

// Stream implements ExtendedHTTPClient interface
func (mec *MockExtendedClient) Stream(ctx context.Context, req *http.Request) (httpclient.StreamResponse, error) {
        resp, err := mec.Do(req)
        if err != nil {
                return nil, err
        }
        return httpclient.NewStreamResponse(resp), nil
}
...
func (mec *MockExtendedClient) copyInterface(src, dst any) error {
